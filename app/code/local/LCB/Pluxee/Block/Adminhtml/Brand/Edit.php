...
class LCB_Pluxee_Block_Adminhtml_Brand_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('brand_data') && Mage::registry('brand_data')->getId()) {
            return Mage::helper('lcb_pluxee')->__("Edit Brand '%s'", $this->escapeHtml(Mage::registry('brand_data')->getLabel()));
        }
